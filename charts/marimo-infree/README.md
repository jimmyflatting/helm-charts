...
| service.image.custom.version | string | `"inseefrlab/onyxia-jupyter-pyspark:py3.12.9-spark3.5.4"` |  |
| service.image.pullPolicy | string | `"IfNotPresent"` |  |
| service.image.version | string | `"inseefrlab/onyxia-jupyter-pyspark:py3.12.9-spark3.5.4"` |  |
